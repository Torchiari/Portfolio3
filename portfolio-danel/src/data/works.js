const works = [
  ...
  },
  {
    ...
    description:
      "Plataforma de comercio electrónico Full Stack con arquitectura cliente-servidor separada. Cuenta con autenticación segura (JWT), carrito de compras dinámico, dashboard de usuario con historial de pedidos y base de datos relacional en la nube. Desarrollado con buenas prácticas y tipado estricto.",
    technologies: [
      "Next.js 15",
      "React",
      "TypeScript",
  ...
  {
    imgSrc: "/images/huracanciclista-preview1.png",
    title: "Huracán Ciclista Club",
    tags: ["Next.js", "NestJS", "PostgreSQL"],
    projectLink: "https://huracanciclista.com.ar/",
    repoLink: "https://github.com/Torchiari/Huracan",
    description:
      "Plataforma web desarrollada para la gestión integral de jugadores y certificados médicos del club Huracán Ciclista. El sistema permite a los jugadores registrarse, completar sus datos personales y subir fichas médicas o certificados de salud desde una interfaz moderna y responsiva. Además, cuenta con un panel administrativo para el médico del club, donde puede visualizar, buscar y administrar la información de los jugadores y la documentación cargada. La aplicación fue desarrollada priorizando rendimiento, seguridad y experiencia de usuario. Pensado para poder escalar y ser utilizado por socios.",
    technologies: [
      "Next.js 15",
      "React",
      "TypeScript",
